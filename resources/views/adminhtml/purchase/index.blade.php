                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            <tr class="text-dark">
                                                ...
                                                <td>:</td>
                                                <td>{{ $order->street . ' ' . $order->outdoor . ' ' . $order->indoor }}
                                                </td>
                                            </tr>
                                            <tr class="text-dark">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <x-flash type="info" dismiss="yes">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>Búscalo en la configuración del teléfono celular, son entre
                                                            15 y
                                                            17
                                                            números</li>
                                                        <li>Encuéntralo impreso en la etiqueta de la batería del
                                                            teléfono
                                                            celular</li>
                                                    </ul>
                                                </x-flash>
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <x-form-input name="birday" type="date" size="s">Fecha
                                                        de
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <x-form-input name="postcode" required="true"
                                                        size="xs">Código
                                                        postal
                                                    </x-form-input>
                                                    ...
                                                    <x-form-input name="city" required="true"
                                                        size="xs">Municipio
                                                    </x-form-input>
                                                    <x-form-input name="region" required="true"
                                                        size="xs">Estado
                                                    </x-form-input>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <x-form-switch name="portabilidad" checked="0">Requiere
                                                    portabilidad
                                                </x-form-switch>

                                                <div id="pannel_portabilidad" class="pannel">
                                                    <x-flash type="info" dismiss="yes">
                                                        <p class="font-weight-bold">Hay dos formas de obtener tu NIP
                                                        </p>
                                                        <ul>
                                                            <li>Envia un SMS al 051 con la palabra NIP, llama al 051
                                                                desde
                                                                el
